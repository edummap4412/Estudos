...
keyname='Pywin32 tests transacted registry functions'
subkeyname='tests transacted subkey'
classname='Transacted Class'

trans=win32transaction.CreateTransaction(Description='tests RegCreateKeyTransacted')
...
## tests transacted delete
del_trans=win32transaction.CreateTransaction(Description='tests RegDeleteKeyTransacted')
