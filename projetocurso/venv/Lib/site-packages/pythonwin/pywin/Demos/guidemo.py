# GUI Demo - just a worker script to invoke all the other demo/tests scripts.
import win32ui
import __main__
import sys
import regutil
...
#	('Font', 'import fontdemo;fontdemo.FontDemo()'),
	('Open GL Demo', 'import openGLDemo;openGLDemo.tests()'),
	...
	('Custom Toolbars and Tooltips', 'import toolbar;toolbar.tests()'),
	...
	('OCX Serial Port Demo', 'from ocx import ocxserialtest;	ocxserialtest.tests()'),
