...
def test1():
	...
	if klass is None:
		print("Can not tests the MSAccess Calendar control - it does not appear to be installed")
		return
...
def test2():
	...
	if klass is None:
		print("Can not tests the Video OCX - it does not appear to be installed,")
