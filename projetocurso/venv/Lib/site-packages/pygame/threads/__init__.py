...
#    So it should only tests the best number of workers +2
MAX_WORKERS_TO_TEST = 64


def init(number_of_workers=0):
    """ Does a little tests to see if threading is worth it.
...
def benchmark_workers(a_bench_func=None, the_data=None):
    """ does a little tests to see if workers are at all faster.
