"""Load and run the Pygame tests suite

python -c "import pygame.tests.go" [<tests options>]

or

python tests/go.py [<tests options>]

Command line option --help displays a command line usage message.

run_tests.py in the main distribution directory is an alternative to tests.go
...
# args will be the tests module list, passed as positional argumemts.
