...
class SurfaceTypeTest(AssertRaisesRegexMixin, unittest.TestCase):
    ...
    def test_fill_negative_coordinates(self):
        ...
        # make subsurface in the middle to tests it doesn't over write.
    ...
    def test_get_flags__display_surf(self):
        ...
        try:
            ...
            try:
                ...
                pass  # If we can't create OPENGL surface don't try this tests
            else:
...
class GeneralSurfaceTests(AssertRaisesRegexMixin, unittest.TestCase):
    ...
    def test_get_colorkey(self):
        ...
        try:
            ...
            # tests for ideal case
            self.assertEqual(s.get_colorkey(), (r, g, b, 255))

            # tests for if the color_key is set using pygame.RLEACCEL
            s.set_colorkey(colorkey, pygame.RLEACCEL)
            self.assertEqual(s.get_colorkey(), (r, g, b, 255))

            # tests for if the color key is not what's expected
            ...
            # tests for using method when display is created with OpenGL and the SDL version is 1
            ...
            # tests for using method after display.quit() is called...
    ...
    def test_get_locks(self):
        ...
        # tests on a surface that is not initially locked
        surface = pygame.Surface((100, 100))
        self.assertEqual(surface.get_locks(), ())

        # tests on the same surface after it has been locked
        surface.lock()
        self.assertEqual(surface.get_locks(), (surface,))

        # tests on the same surface after it has been unlocked
        surface.unlock()
        self.assertEqual(surface.get_locks(), ())

        # tests with PixelArray initialization: locks surface
    ...
    def test_palette_colorkey(self):
        """tests bug discovered by robertpfeiffer
...
class SurfaceBlendTest(unittest.TestCase):
    ...
    def test_blit_blend_big_rect(self):
        """tests that an oversized rect works ok."""
        color = (1, 2, 3, 255)
        area = (1, 1, 30, 30)
        s1 = pygame.Surface((4, 4), 0, 32)
...
class SurfaceSelfBlitTest(unittest.TestCase):
    ...
    This tests case is in response to MotherHamster Bugzilla Bug 19.
    """
