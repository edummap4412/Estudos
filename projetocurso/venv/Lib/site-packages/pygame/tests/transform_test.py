...
class TransformModuleTest(unittest.TestCase):
    ...
    def test_threshold_dest_surf_not_change(self):
        ...
        So there should be none changed in this tests.
        """
        (w, h) = size = (32, 32)
        threshold = (20, 20, 20, 20)
        original_color = (25, 25, 25, 25)
    ...
    def test_get_smoothscale_backend(self):
        ...
        # It would be nice to tests if a non-generic type corresponds to an x86
        # processor. But there is no simple tests for this. platform.machine()
...
class TransformDisplayModuleTest(unittest.TestCase):
    ...
    def test_flip(self):
        ...
        # now we tests the convert() ed image also works.
        surf.fill((255, 255, 255))
        surf2.fill((255, 255, 255))
    ...
    def test_flip_alpha(self):
        ...
        # now we tests the alpha image works.
        surf.fill((255, 255, 255))
        surf2.fill((255, 255, 255))
