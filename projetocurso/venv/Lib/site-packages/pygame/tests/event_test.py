...
This tests is dependent on timing. The event queue is cleared in preparation for
tests. There is a small window where outside events from the OS may have effected
results. Try running the tests again.
"""
...
class EventModuleTest(unittest.TestCase):
    ...
    # @unittest.skip("At the moment, this tests seems to fail on all platforms")
    ...
    def test_set_grab__and_get_symmetric(self):
        ...
        WARNING: Moving the mouse off the display during this tests can cause it
                 to fail.
        """
        surf = pygame.display.set_mode((10, 10))
    ...
    def todo_test_get_grab(self):
        ...
        # tests if the program is sharing input devices
        #
