...
class MixerModuleTest(unittest.TestCase):
    ...
    def test_init__keyword_args(self):
        # note: this tests used to loop over all CONFIGS, but it's very slow..
        mixer.init(**CONFIG)
    ...
    @unittest.skipIf(
        ...
        "this tests fails without real sound card",
    )
    ...
    def todo_test_get_busy(self):
        ...
        # tests if any sound is being mixed
        #
...
class ChannelTypeTest(AssertRaisesRegexMixin, unittest.TestCase):
    ...
    def setUp(cls):
        # This makes sure the mixer is always initialized before each tests (in
        # case a tests calls pygame.mixer.quit()).
...
class SoundTypeTest(AssertRaisesRegexMixin, unittest.TestCase):
    ...
    def test_sound__from_file_object(self):
        ...
        # Using 'with' ensures the file is closed even if tests fails.
