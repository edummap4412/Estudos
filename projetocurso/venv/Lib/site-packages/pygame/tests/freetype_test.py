...
class FreeTypeFontTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # A scalable mono tests font made for pygame. It contains only
        ...
        # A fixed size bitmap mono tests font made for pygame.
    ...
    def test_freetype_Font_dealloc(self):
        ...
        try:
            ...
            # Ensures file is closed even if tests fails.
            handle.close()
    ...
    def test_freetype_Font_kerning__enabled(self):
        ...
        Note: This does not tests what changes occur to a rendered font by
        ...
        try:
            ...
            for i, surf in enumerate(surfaces):
                ...
                if surf.get_bitsize() == 24:
                    # For a 24 bit target surface tests against Pygame's alpha
    ...
    # This Font cache tests is conditional on freetype being built by a debug
    ...
    def test_issue_237(self):
        ...
        if font.name != name:
            # The font is unavailable, so skip the tests.
            return
        font.underline = True
