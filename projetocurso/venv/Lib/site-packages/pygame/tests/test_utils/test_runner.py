...
Traceback (most recent call last):
  File "tests/%(module)s.py", line 1, in all_tests_for
...
def extract_tracebacks(output):
    """ from tests runner output return the tracebacks.
    """
...
def output_into_dots(output):
    """ convert the tests runner output into dots.
    """
    # verbose_mode = ") ..." in output
    verbose_mode = " ..." in output
...
if __name__ == "__main__":
    ...
    if not args:
        ...
        sys.exit("No tests module provided; consider using %s instead" % run_from)
    run_test(
        args[0],
