...
def run(*args, **kwds):
    """Run the Pygame unit tests suite and return (total tests run, fails dict)
    ...
    usesubprocess - run all tests suites in the current process
                   (default False, use separate subprocesses)
    dump - dump failures/errors as dict ready to eval (default False)
    file - if provided, the name of a file into which to dump failures/errors
    timings - if provided, the number of times to run each individual tests to
              get an average run time (default is run each tests once)
    ...
    By default individual tests modules are run in separate subprocesses. This
    ...
    interactions between tests modules. Also, a time limit is placed on tests
    ...
    Individual tests modules may have a corresponding *_tags.py module,
    ...
    ###########################################################################
    # Compile a list of tests modules. If fake, then compile list of fake
