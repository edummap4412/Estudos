...
# Add a literal string to the format insertion tests to catch trivial re-format algorithms

# Revision 1.13  2013/05/08 14:31:50  kf7xm
# Quick switch to Turn off IDEMPOTENT_CLOSE tests. Also: Silence teardown failure
...
class DatabaseAPI20Test(unittest.TestCase):
    ...
    def test_close(self):
        ...
        #!!! reasonable persons differ about the usefulness of this tests and this feature !!!
