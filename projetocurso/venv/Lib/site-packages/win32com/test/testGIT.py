...
When this tests is run in "free threaded" mode (at this stage, you must
...
def DoTestInterpInThread(cookie):
        try:
            ...
            print("The tests thread id is %d, Python.Interpreter's thread ID is %d" % (myThread, interp.Eval("win32api.GetCurrentThreadId()")))
            interp = None
