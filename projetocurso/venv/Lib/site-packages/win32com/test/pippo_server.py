# A little tests server, complete with typelib, we can use for testing.
# Originally submitted with bug:
# [ 753154 ] memory leak wrapping object having _typelib_guid_ attribute
# but modified by mhammond for use as part of the tests suite.
import sys, os
import pythoncom
import win32com
import winerror
...
class CPippo:
    ...
    _reg_desc_ = "Pippo Python tests object"
