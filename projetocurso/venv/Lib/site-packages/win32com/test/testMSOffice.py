# Test MSOffice
#
# Main purpose of tests is to ensure that Dynamic COM objects
# work as expected.
...
def TestWord():
    ...
    try:
        ...
        print("Starting Word 8 for dynamic tests")
        word = win32com.client.dynamic.Dispatch("Word.Application")
        TestWord8(word)

        word = None
        # Now we will tests Dispatch without the new "lazy" capabilities
        print("Starting Word 8 for non-lazy dynamic tests")
        ...
        print("Starting Word 7 for dynamic tests")
        word = win32com.client.Dispatch("Word.Basic")
        TestWord7(word)

    print("Starting MSWord for generated tests")
    from win32com.client import gencache
...
def TestWord8OldStyle():
    try:
        ...
        print("Can not do old style tests")
...
def TestAll():
    ...
    print("Starting Excel for Dynamic tests...")
    xl = win32com.client.dynamic.Dispatch("Excel.Application")
    TextExcel(xl)

    try:
        print("Starting Excel 8 for generated excel8.py tests...")
    ...
    try:
        ...
        print("Starting Excel 95 for makepy tests...")
        TextExcel(xl)
    except ImportError:
