...
class AXScript(win32com.test.util.TestCase):
    ...
    def testHost(self):
        file = win32api.GetFullPathName(os.path.join(win32com.axscript.__path__[0], "tests\\testHost.py"))
    ...
    def testCScript(self):
        file = win32api.GetFullPathName(os.path.join(win32com.axscript.__path__[0], "Demos\\Client\\wsh\\tests.pys"))
