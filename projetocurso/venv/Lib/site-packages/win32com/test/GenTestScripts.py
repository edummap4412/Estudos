...
#       tlb = apply(pythoncom.LoadRegTypeLib, loadArgs)
    ...
    f.close()
    print("compiling -", end=' ')
    fullModName = "win32com.tests.%s.%s" % (genDir, fname)
...
def GenerateAll():
    for args in genList:
        try:
            ...
            print("** Could not generate tests code for ", args[0])

def CleanAll():
    print("Cleaning generated tests scripts...")
    ...
    try:
        ...
        print("Could not delete tests directory -", details)
