# The purpose of this tests is to ensure that the gateways objects
# do the right thing WRT COM rules about object identity etc.

# Also includes a basic tests that we support inheritance correctly in
# gateway interfaces.

# For our tests, we create an object of type IID_IPersistStorage
...
def TestGatewayInheritance():
    ...
    # As the object is correctly discarded, it doesnt affect this tests.
