...
class DirectSoundTest(unittest.TestCase):
    ...
    def testPlay(self):
        ...
        # look for the tests file in various places
        candidates = [
            os.path.dirname(__file__),
            os.path.dirname(sys.argv[0]),
            # relative to 'testall.py' in the win32com tests suite.
            os.path.join(os.path.dirname(sys.argv[0]),
                         '../../win32comext/directsound/tests'),
            '.',
        ]
        for candidate in candidates:
            ...
            raise TestSkipped("Can't find tests .wav file to play")
